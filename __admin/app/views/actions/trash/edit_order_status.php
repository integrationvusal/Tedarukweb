...
<div class="content-box">
    ...
    <div class="content-box-content">
        ...
        {
            $id = (int)$_GET['id'];
            $data_q = $pdo->query("SELECT * FROM `cs_orders_status` WHERE `id`=".$pdo->quote($id)."")->fetch(PDO::FETCH_ASSOC);
        }
        ...
        if( isset($_POST['add_status']) && $_POST['status_name_az'] != ''  && $_POST['status_name_en'] != ''  && $_POST['status_name_ru'] != '' )
        {
            ...
            $stmt = $pdo->prepare("UPDATE `cs_orders_status` SET `name_ru`= :name_ru , `name_az` = :name_az ,`name_en` = :name_en WHERE `id`=".$pdo->quote($id)."");
            ...
            <form name="add_status" action="" method="POST">
                ...
                <p>
                    ...
                    <input class="text-input small-input" type="text" name="status_name_az" value="<?=$data_q['name_az']?>" />
                </p>
                <p>
                    <label >Название статуса (RU)</label>
                    <input class="text-input small-input"  type="text" name="status_name_ru"  value="<?=$data_q['name_ru']?>"/>
                </p>
                <p>
                    <label >Название статуса (EN)</label>
                    <input class="text-input small-input" type="text" name="status_name_en"  value="<?=$data_q['name_en']?>"/>
                </p>
