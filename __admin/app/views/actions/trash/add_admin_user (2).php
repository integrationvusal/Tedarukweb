...
if(isset($add_admin)) {
    ...
    @$_SESSION['add_admin_login']=$admin_login;
    @$_SESSION['add_admin_name']=$admin_name;
    @$_SESSION['add_admin_surname']=$admin_surname;
    @$_SESSION['add_admin_type']=$admin_type;
    @$_SESSION['add_admin_block']=$admin_block;
    ...
    if($err==0){
        ...
        unset($_SESSION['add_admin_login']);
        unset($_SESSION['add_admin_name']);
        unset($_SESSION['add_admin_surname']);
        unset($_SESSION['add_admin_type']);
        unset($_SESSION['add_admin_block']);
...
<div class="content-box">
    ...
    <div class="content-box-content">
        ...
        <form method="POST">
            ...
            <p>
                <label>Логин</label>
                <input class="text-input small-input" value="<?php echo @$_SESSION['add_admin_login']; ?>" type="text" name="admin_login" />
            </p>
            ...
            <p>
                <label>Имя</label>
                <input class="text-input small-input" value="<?php echo @$_SESSION['add_admin_name']; ?>" type="text" name="admin_name" />
            </p>

            <p>
                <label>Фамилия</label>
                <input class="text-input small-input" value="<?php echo @$_SESSION['add_admin_surname']; ?>" type="text" name="admin_surname" />
            </p>
