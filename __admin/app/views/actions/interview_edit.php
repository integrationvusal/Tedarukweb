...
<section class="content-header">
	<h1>
		<?=CMS::t('menu_item_interview_edit');?>
...
<section class="content">
	...
	<div class="box" style="border-top: none;">
		<!-- <div class="box-header with-border">
			<h3 class="box-title"><?=CMS::t('menu_item_interview_edit');?></h3>
		</div> -->
		<!-- /.box-header -->
...
// ]]>
						...
						<div class="tab-pane active" id="common-tab">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="id-number"><?=CMS::t('interview_id_num')?>: &nbsp; <?=$news['id']?></label>
									</div>
									<div class="form-group">
										<label><a href="https://google.com/?q=SEF+friendly+urls" title="" target="_blank"><?=CMS::t('interview_sef');?> <i class="fa fa-external-link" aria-hidden="true" style="font-size: inherit;"></i></a></label>
									...
									<div class="form-group">
										...
										<div class="image-preview">
											...
											<div class="image-preview-info">
												...
												?>
												<?=CMS::t('interview_image_original_size');?>: <?=$orgSize['value'];?> <?=$orgSize['measure'];?><br />
												<?=CMS::t('interview_image_thumbnail_size');?>: <?=$tmbSize['value'];?> <?=$tmbSize['measure'];?><br />
												<?=CMS::t('interview_image_original_upload_datetime');?>: <?=($imgModTimestamp? date('d.m.Y H:i:s', $imgModTimestamp): '-');?><br />
												<br />
												<br />
												<?php if ($preview_exists) { ?>
												<a href="<?=$previewUrl;?>" target="_blank"><img src="<?=IMAGE_DIR;?>eye_white.png" alt="" style="height: 16px;" /> <?=CMS::t('interview_image_original_view');?> <img src="<?=IMAGE_DIR;?>outer_link_white.png" alt="" /></a>
												<?php } ?>
												<?php if (CMS::hasAccessTo('interview/ajax_delete_image', 'write')) { ?>
												<a href="?controller=interview&amp;action=ajax_delete_image" id="aDelImg"><img src="<?=IMAGE_DIR;?>drop_white.png" alt="" style="height: 16px;" /> <?=CMS::t('delete');?></a>
												</p>
												<?php } ?>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group">
													...
													<input type="text" name="add_date" value="<?=utils::safePostValue('add_date', utils::formatMySQLDate('d.m.Y', $news['add_datetime']), 1);?>" placeholder="<?=CMS::t('interview_publish_date_placeholder');?>" class="form-control datepicker" />
												</div>
									...
									<div class="form-group">
										...
										<div class="row">
											<div class="col-xs-6">
												<div class="input-group">
													<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
													<input type="text" name="publish_date" value="<?=utils::safePostValue('publish_date', utils::formatMySQLDate('d.m.Y', $news['publish_datetime']), 1);?>" placeholder="<?=CMS::t('interview_publish_date_placeholder');?>" class="form-control datepicker" />
												</div>
