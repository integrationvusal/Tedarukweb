						...
						?>
							<tr>
								<td>
									...
									<?=view::gravatar($user['email'], 40, ['class' => 'userpic']);?>
									<?php } else { ?>
									<img src="<?=UPLOADS_DIR;?>avatars/site_users/<?=$user['avatar'];?>" alt="" class="userpic" />
									<?php } ?>
									<?=$user['email'];?>
								</td>
								<td>
								...
								<td>
									<?=utils::formatMySQLDate('d.m.Y H:i:s', $user['registration_datetime']);?>
								</td>
								<td>
