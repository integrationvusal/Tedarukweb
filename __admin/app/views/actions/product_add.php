...
<section class="content">
	...
	<div class="box">
		<!-- <div class="box-header with-border">
			<h3 class="box-title"><?=CMS::t('menu_item_product_add');?></h3>
		</div> -->
		<!-- /.box-header -->
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							<label><?=CMS::t('product_name');?> *</label>
							<input type="text" name="name" class="form-control" autocomplete="off" />
						</div>
						
						<div class="form-group">
							<input type="checkbox" name="is_published" value="1"<?=((isset($_POST['is_published']) && empty($_POST['is_published']))? '': ' checked="checked"');?> id="triggerproductStatus" /><label for="triggerproductStatus" style="display: inline; font-weight: normal;"> <?=CMS::t('publish');?></label>
						</div>
					</div>
				</div>
			</div>
