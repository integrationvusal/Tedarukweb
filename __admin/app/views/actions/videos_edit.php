						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<div class="div-tabs tab-video">
									...
									<input placeholder="http://www.youtube.com/watch?v=bQr3H3ToW-Q" type="text" name="link" value="<?=isset($_POST['link'])?utils::safeEcho($_POST['link'], 1):$data['link'];?>" class="form-control">
								</div>
							</div>
