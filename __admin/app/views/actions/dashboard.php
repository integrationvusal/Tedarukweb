			...
			*/?>
			...
			<div class="col-lg-3 col-xs-6">
				<div class="small-box bg-blue">
					<div class="inner">
						...
						<p><?=CMS::t('dashboard_documents_posted', [
					...
					<a href="<?=view::create_url('documents', 'list')?>" class="small-box-footer"><?=CMS::t('more_info');?> <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
			...
			<div class="col-lg-3 col-xs-6">
				<div class="small-box bg-red">
					...
					<a href="<?=view::create_url('cms_users', 'list')?>" class="small-box-footer"><?=CMS::t('more_info');?> <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
		</div>
