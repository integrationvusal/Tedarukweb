			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?=utils::safeEcho($gal['selected_cats'], true) ?>
						</td>
						<td>
						...
						<td style="white-space: nowrap;">
							...
							<a class="open-album" href="<?=SITE.CMS_DIR.JS_DIR?>filemanager/dialog.php?fldr=albums/<?=$gal['name']?>&hash=<?=CMS::$sess_hash?>&<?=uniqid()?>" style="margin-left: 10px;" title="<?=CMS::t('gallery_photos_list');?>">
