...
?>
	...
	<section class="content-header">
		<h1>
			<?=CMS::t('menu_item_actual_links_add');?>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label><?=CMS::t('actual_links_title');?> *</label>

								<input type="text" name="title" value="<?=utils::safeEcho(@$_POST['title'], 1);?>" class="form-control" autocomplete="off" />
							</div>
							<div class="form-group">
								<label><?=CMS::t('actual_links_link');?> *</label>

								<input type="url" name="link" value="<?=utils::safeEcho(@$_POST['link'], 1);?>" class="form-control" autocomplete="off" />
							</div>
						</div>
					</div>
				</div>
