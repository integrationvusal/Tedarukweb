					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label><?=CMS::t('keywords_keyword');?> *</label>

								<input type="text" name="keyword" value="<?=utils::safeEcho(@$_POST['keyword'], 1);?>" class="form-control" autocomplete="off" />
							</div>
						</div>
					</div>
				</div>
