...
class pages_controller extends controller {
	...
	public static function action_list() { // 2016-09-12
		...
		view::$title = CMS::t('menu_item_pages_list');

		$params = [];

		$page = intval(@$_GET['page']);
		pages::$curr_pg = (empty($page)? 1: $page);

		$params['pages'] = pages::getPagesList();
		$params['count'] = pages::$items_amount;
		$params['total'] = pages::$pages_amount;
		$params['current'] = pages::$curr_pg;
		...
		$params['canWrite'] = CMS::hasAccessTo('pages/list', 'write');

		return self::render('pages_list', $params);
	}
