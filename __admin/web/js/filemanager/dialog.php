...
if( ! (isset($_GET['hash'], $_SESSION['EditorAuthorized']) && in_array($_GET['hash'], array_keys($_SESSION))) && !isset($_SESSION["verify"]) )  
	die('Access Denied!');
...
foreach(['lang', 'fldr', 'field_id', 'type', 'popup', 'editor'] as $g) 
	if(isset($_GET[$g])) 
		$_GET[$g] = htmlspecialchars(strip_tags($_GET[$g])); 
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script> //if(top == self) location.href = location.origin; </script>
    ...
    <body>
		<input type="hidden" id="csrf" value="<?php echo $_SESSION['csrf_key']; ?>" />
...
<!----- header div end ------->
	...
	<div class="span12">
		...
		elseif($_GET['type']==0 && $_GET['field_id']=='') $apply = 'apply_img';
